...
BEGIN
	Select * from usuario where correo=pCorreo and contrasenna=pPassword and estado='1';
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    ...
    ELSE
        ...
        SELECT 1 AS resultado, 'El Usuario fue registrado correctamente' AS mensaje;
    END IF;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
